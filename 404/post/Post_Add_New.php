                            ...
                            <div class="row">
                                    ...
                                    <div class="">            
                                        <form method="POST" name="fpost" id="fpost"  role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="draft" type="submit" value="Save Draft" class="btn btn-primary">
                                ...
                                <div class="col-md-4 col-lg-4 hidden-sm hidden-xs"> 
                                    ...
                                    <section class="panel panel-default portlet-item">
                                        ...
                                        <section class="panel-body"><?php $menu->LoadRelatedPostsInAdmin(1); ?></section> </section>
                                </div>
                            </div>
                        </section>
                    </section>
