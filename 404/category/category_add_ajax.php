...
<div class="wrapper"> <h4 class="m-t-none">Add New Category</h4> 
                ...
                <label>Name</label>
                <input type="text" name="name" id="name" value="" placeholder="Category Name" class="input-sm form-control">
                </div>
                ...
                <option class="form-control" value='0'>No</option>
                    ...
                    <div class="m-t-lg">
                        ...
                        <input type="text" name="is_menu" id="is_menu" value="2" class="input-sm form-control hide">
                        <input type="text" name="is_navbar" id="is_navbar" value="0" class="input-sm form-control hide">
                        <input type="text" name="is_submenu" id="is_submenu" value="1" class="input-sm form-control hide">
                        <input type="submit" id="addcat" value="Add Menu" class="btn btn-primary btn-block"></div> 
                </form> </div>
    </aside>