...
<body class="">
            ...
            <header class="panel-heading bg-light no-border"> 
                <div class="clearfix"> <a href="#" class="pull-left thumb-md avatar b-3x m-r"> 
                        <img src="../../images/<?php echo $image->getIMAGE_LINK(); ?>" alt="..."> </a> <div class="clear"> 
                            ...
                            <small class="text-muted"><?php echo $staff->getDESIGNATION(); ?></small> </div> </div> 
            </header>
             ...
             <span class="hidden-sm">Details</span> </header> 
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"> <span class="pull-right"><?php echo $user->getAddress(); ?></span>  Address </li>
                            <li class="list-group-item"><span class="pull-right"><?php echo $staff->getQUALIFICATION(); ?></span>  Qualifications </li>
                            <li class="list-group-item"> <span class="pull-right"><?php echo $staff->getSUBJECT(); ?></span>  Subject </li>
                            <li class="list-group-item"> <span class="pull-right"><?php echo $staff->getCATEGORY_ID(); ?></span>  Staff Type </li>
    ...
    <div class="col-md-4 col-lg-4 hidden-sm hidden-xs"> 
                                    <section class="panel panel-default portlet-item">
                                        <header class="panel-heading">Related Staff List</header>
                                        <section class="panel-body"><?php $user->LoadRelatedStaffInAdmin($staff->getCATEGORY_ID(),$id); ?></section> </section>
                                </div>
                                </div>
