...
<div class="wrapper"> <h4 class="m-t-none">Add New Page As Menu</h4>
    <div class="btn-group-justified"><button id="sidehide" class="btn-primary btn-block"><< Back</button></div>
                ...
                <div class="form-group"> <label>Name</label>
                    <input type="text" name="menu" id="name" placeholder="Page name" class="input-sm form-control"> </div>
                
                    <input type="text" name="prentid" id="prentid" value='0' class="input-sm form-control hide">
                    <input type="text" name="is_menu" id="is_menu" value='1' class="input-sm form-control hide">
