...
<div class="wrapper"> <h4 class="m-t-none">Add New Sub Menu</h4>
    <div class="btn-group-justified"><button id="sidehide" class="btn-primary btn-block"><< Back</button></div>
                ...
                <div class="form-group"> <label>Name</label>
                    <input type="text" name="menu" id="name" placeholder="Sub Menu name" class="input-sm form-control"> </div>
                    
                    <div class="form-group"> <label>Parent (<?php echo $menu->CountSubMenu();?>)</label> 
                    <select name="prentid" id="prentid" class="form-control">
                <?php $menu->LoadMenuParent();?>
                                                 </select> </div>
...
<?php
    ...
    echo '<div class="wrapper"> <h4 class="m-t-none">Add New Menu</h4>
    <div class="btn-group-justified"><button id="sidehide" class="btn-primary btn-block"><< Back</button></div>
                <form  method="post" id="fmenu" role="form">
                <div class="form-group"> <label>Name</label>
