                        ...
                        <section class="scrollable wrapper">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                    <h2>Add New Page <a id="cancel" href="index.php" class="btn btn-default btn-rounded pull-right">Cancel</a></h2>
                                    <div id="success"></div>
                                    <div class="">            
                                        <form method="POST" name="fpost" id="fpost"  role="form">
                                            ...
                                            <div class="form-group">
                                                <input id="save" type="submit" value="Save changes" class="btn btn-success btn-rounded">    
                                                <input id="draft" type="submit" value="Save Draft" class="btn btn-primary btn-rounded pull-right">
                                ...
                                <div class="col-md-4 col-lg-4 hidden-sm hidden-xs"> 
                                    <section class="panel panel-default portlet-item">
                                        <header class="panel-heading">Related Page</header>
                                        <section class="panel-body"><?php $menu->LoadRelatedpagesInAdmin(1); ?></section> </section>
                                </div>
                            </div>
                        </section>
                    </section>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#save", function () {
                ...
                if (vname == '') {
                    ...
                    $.post("Page_Add.php", //Required URL of the page on server
                            {
                                NAME: vname,
                                PUBLISH: vis_publish,
                                PARENT: vprentid,
