...
function watermark_image1($oldimage_name, $new_image_name){
    global $image_path;
...
$images->setIMG_DESCRIPTIONS($IMGD);
$images->InsertPhoto();
$menu->setIMAGE_ID($images->getLastId());
$menu->UpdateImage($POSTID);
$menu->pageRedirect("image_by_albumwise.php?i=".$Cate);
}
}
