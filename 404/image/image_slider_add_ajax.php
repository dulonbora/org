...
<h3 class="text-center text-info">Add Image To Slider</h3>
...
<form action="img_Upload.php" method="POST" name="form2" id="uploadForm" enctype="multipart/form-data" role="form" > 
    ...
    <div class="form-group">
        <label for="IMG_DESCRIPTIONS">Description</label>
        <input type="text" name="IMG_DESCRIPTIONS" value="" class="form-control" placeholder="DESCRIPTIONS">
    </div>
    <div class="form-group">
...
function filePreview(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            $('#imageview').html('<img class="text-center" src="'+e.target.result+'" width="200" height="120"/>');
