...
<div class="row">
                                <div class="col-lg-12">
                                    <section class="panel panel-default"> <header class="panel-heading">Gallery Album List</header> 
                                        <div class="row wrapper">  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 m-b-xs"> 
                                                <div class="btn-group" data-toggle="buttons"> 
                                                    <button id="addnew" class="btn btn-sm btn-default btn-block active">Add New Album</button>
...
$(document).ready(function(){
    ...
    $("#menuaside").load("image_cat_add_ajax.php").toggle(600);
    });
...
$.post("Gallery_Add.php", //Required URL of the page on server
{
NAME:vname,
PAGE:vis_menu,
NAVBAR:vis_navbar,
